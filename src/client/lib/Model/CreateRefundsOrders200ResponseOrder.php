...
/**
 * CreateRefundsOrders200ResponseOrder Class Doc Comment
 *
 * @category Class
 * @package  PayPlayClient
 * @author   OpenAPI Generator team
 ...
 */
class CreateRefundsOrders200ResponseOrder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createRefundsOrders_200_response_order';
    ...
    protected static $openAPITypes = [
        ...
        'failure_link' => 'string',
        'transactions' => '\PayPlayClient\Model\GetOrders200ResponseOrderTransactionsInner[]'
    ];
    ...
    protected static $setters = [
        ...
        'is_refund_available' => 'setIsRefundAvailable',
    ...
    protected static $getters = [
        ...
        'is_refund_available' => 'getIsRefundAvailable',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_refund_available', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_refund_available'] === null) {
            $invalidProperties[] = "'is_refund_available' can't be null";
        }
        if ($this->container['is_refunded'] === null) {
            $invalidProperties[] = "'is_refunded' can't be null";
        }
    ...
    /**
     * Gets is_refund_available
     *
     * @return bool
     */
    public function getIsRefundAvailable()
    {
        return $this->container['is_refund_available'];
    }

    /**
     * Sets is_refund_available
     *
     * @param bool $is_refund_available is_refund_available
     *
     * @return self
     */
    public function setIsRefundAvailable($is_refund_available)
    {
        if (is_null($is_refund_available)) {
            throw new \InvalidArgumentException('non-nullable is_refund_available cannot be null');
        }
        $this->container['is_refund_available'] = $is_refund_available;
     ...
     * Sets is_refunded
     *
     * @param bool $is_refunded is_refunded
     *
     * @return self
     */
     ...
     * Gets transactions
     *
     * @return \PayPlayClient\Model\GetOrders200ResponseOrderTransactionsInner[]
     */
     ...
     * Sets transactions
     *
     * @param \PayPlayClient\Model\GetOrders200ResponseOrderTransactionsInner[] $transactions transactions
     *
     * @return self
     */
