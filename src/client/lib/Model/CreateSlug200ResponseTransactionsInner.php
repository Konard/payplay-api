<?php
/**
 * CreateSlug200ResponseTransactionsInner
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CreateSlug200ResponseTransactionsInner Class Doc Comment
 *
 * @category Class
 * @package  PayPlayClient
 * @author   OpenAPI Generator team
 ...
 */
class CreateSlug200ResponseTransactionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createSlug_200_response_transactions_inner';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'currency' => '\PayPlayClient\Model\CreateSlug200ResponseTransactionsInnerCurrency',
        'value' => 'string',
        'status' => 'string',
        'type' => 'string',
        'network' => 'string',
    ...
    */
     ...
     * Gets currency
     *
     * @return \PayPlayClient\Model\CreateSlug200ResponseTransactionsInnerCurrency
     */
     ...
     * Sets currency
     *
     * @param \PayPlayClient\Model\CreateSlug200ResponseTransactionsInnerCurrency $currency currency
     *
     * @return self
     */
